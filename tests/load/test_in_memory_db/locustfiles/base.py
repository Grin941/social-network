...
from tests.load.test_in_memory_db.locustfiles import uow
...
class InMemoryDbUser(mixin.AsyncMixin, locust.HttpUser):
    """
    Проверяем влияние Redis UDF на диалоги пользователей
